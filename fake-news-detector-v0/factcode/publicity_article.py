...
if __name__ == '__main__':
    ...
    articletitle, summary3, journalist = cm.crawl_navernews(query)
    ...
    conjuction_check = conjunction_association(summary3)

    # Final Score Evaluation
    reliability_2 = evaluation_moduleB(sudden_leap_degree, conjuction_check, param_arrayB=[0.5,0.5,0])
    print(reliability_2)