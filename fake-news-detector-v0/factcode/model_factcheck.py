...
def publicity_article_checker(articletitle, summary3, summary4):
    ...
    # 접속사 연결 관계 파악
    conjuction_check = modB.conjunction_association(summary4)

    # Final Score Evaluation
    reliability_2 = modB.evaluation_moduleB(sudden_leap_degree, conjuction_check, param_arrayB=[0.5,0.5,0])
...
def republishing_same_checker(summary5, reporter, press):
    ...
    # Final Score Evaluation
    reliability_3 = modC.evaluation_moduleC(similarity, reporter_score, press_score, param_array=[0.3,0.3,0.3,0.1])
...
if __name__ == '__main__':
    ...
    press, reporter, articletitle, articlecontents = test.test_functionality(press, reporter, articletitle, articlecontents, mode = 0)
