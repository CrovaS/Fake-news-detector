...
def get_directory(what_you_want):
    directory = ''
    # Type '.../factcode/PositivityCheck/train_dataset_1007.csv' in your disk
    if what_you_want == 'train_directory':
        directory = ".../factcode/PositivityCheck/train_dataset_1007.csv"
    # Type '.../factcode/PositivityCheck/test_dataset_1007.csv' in your disk
    if what_you_want == 'test_directory':
        directory = ".../factcode/PositivityCheck/test_dataset_1007.csv"
    # Type '.../selenium/chromedriver.exe' in your disk
    if what_you_want == 'chromedriver':
        directory = ".../selenium/chromedriver.exe"
